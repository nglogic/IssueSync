...
/*	BTSRDriver outerBTS;
	...
	Date date;
	@Before
	public void init() throws TracConfigurationException{
		...
		synchronizationInnerToOuterMapper.componentMap.put("component1", "com1");
	...
	public void testNewTicketInTracSuccessfullSynchronization() throws ParseException, CommunicationException{
		...
		outerBTS.clearTickets();
			...
			date = f.parse("2013-04-16 16:15:00");
			...
			assertEquals("gosiiek",outerTicket.getReporter());
			assertEquals("gosiiek",outerTicket.getOwner());
			assertEquals("normal",outerTicket.getPriority());
			assertEquals(null,outerTicket.getType());
			assertEquals("com1",outerTicket.getComponent());
			assertEquals("m1",outerTicket.getMilestone());
			System.out.println(outerTicket.getUpdateTime().toString());
			assertEquals("testNewTicketInTracSuccessfullSynchronization",outerTicket.getSummary());
			assertEquals("opis",outerTicket.getDescription());
			assertEquals(null,outerTicket.getComment());
			assertEquals(new Integer(1000), outerTicket.getTicketId());
	
	}
	
	/*@Test
	public void testUpdateTicketInTracSuccessfullSynchronization(){
	...
	@Test
	public void testNewTicketInAssemblaSuccessfullSynchronization(){
		innerBTS.clearTickets();
		outerBTS.clearTickets();
		//ustawiamy tickety
		Ticket ticket1=null;
	...
	@Test
	public void testUpdateTicketInAssemblaSuccessfullSynchronization(){
		innerBTS.clearTickets();
		outerBTS.clearTickets();
		//ustawiamy tickety
		Ticket ticket1=null;
	...
	@Test
	public void testConflitShouldNotSynchronized(){
		innerBTS.clearTickets();
		outerBTS.clearTickets();
		//ustawiamy tickety
	...
	@Test
	public void testReporterNotInFilterShouldNotSynchronized(){
		innerBTS.clearTickets();
		outerBTS.clearTickets();
		//ustawiamy tickety
		Ticket ticket1=null;
	...
	@Test
	public void testOwnerNotInFilterShouldNotSynchronized(){
		innerBTS.clearTickets();
		outerBTS.clearTickets();
		//ustawiamy tickety
		Ticket ticket1=null;
	...
	@Test
	public void testPriorityNotInFilterShouldNotSynchronized(){
		innerBTS.clearTickets();
		outerBTS.clearTickets();
		//ustawiamy tickety
		Ticket ticket1=null;
	...
	@Test
	public void testMilestoneNotInFilterShouldNotSynchronized(){
		innerBTS.clearTickets();
		outerBTS.clearTickets();
		//ustawiamy tickety
		Ticket ticket1=null;
	...
	@Test
	public void testStatusAssemblaTicketNotInMapperSuccessfullSynchronization(){
		innerBTS.clearTickets();
		outerBTS.clearTickets();
		//ustawiamy tickety
		Ticket ticket1=null;
